...
In this sense, dimensionality reduction and clustering are two sides of the same coin. Could we thus measure the quality of a dimension reduction method by how well it enhances the cluster properties in the data? 
