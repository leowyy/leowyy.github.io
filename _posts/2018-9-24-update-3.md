...
---
### Experiment set-up: 
In the following experiments, a reference test set was prepared which consists of 100 separate data sets of sizes in the range [200,500]. <br>
...
<img src="{{ site.baseurl }}/public/update_3/1.png" width="800">

### Experiment 2: Loss function used during training
<img src="{{ site.baseurl }}/public/update_3/2.png" width="800">

Training on the pairwise loss leads to significant improvements. The L2 loss does not reflect the invariance under rotations and reflection when using spectral embeddings.

### Experiment 3: Conv net vs Graph net
<img src="{{ site.baseurl }}/public/update_3/3.png" width="800">
...
#### Comparison of the number of params
  * Conv net: 68,952 
  * Graph net: 298,102 
...
<img src="{{ site.baseurl }}/public/update_3/4.png" width="800">
